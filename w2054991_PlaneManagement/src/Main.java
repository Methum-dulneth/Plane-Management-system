...
public class Main {
    ...
    private static int[][] allseats = {new int [14],new int[12],new int[12], new int[14]};
            ...
            if (row.equals("A") || row.equals("D")) {
                ...
                if (seatNumber <= 14 && seatNumber >= 1) {
                    if (row.equals("A") && allseats[0][seatNumber - 1] == 0) {
                        ...
                        String email = sc1.next();
                        Person p = new Person(name, surname, email);
                        Ticket t = new Ticket("D", seatNumber, price, p);
                        array[ticketCount] = t;
                        ticketCount++;
                        t.save();
                ...
                if (seatNumber <= 12 && seatNumber >= 1) {
                    if (row.equals("B") && allseats[1][seatNumber - 1] == 0) {
                        ...
                        String email = sc1.next();
                        Person p = new Person(name, surname, email);
                        Ticket t = new Ticket("B", seatNumber, price, p);
                        array[ticketCount] = t;
                        ticketCount++;
                        t.save();
                        break;
                        ...
                        String email = sc1.next();
                        Person p = new Person(name, surname, email);
                        Ticket t = new Ticket("C", seatNumber, price, p);
                        array[ticketCount] = t;
                        ticketCount++;
                        t.save();
                        break;
